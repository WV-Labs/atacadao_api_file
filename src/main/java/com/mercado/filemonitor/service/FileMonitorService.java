...
public class FileMonitorService {
    ...
    private Path criarCopiaDoArquivoNoDiretorio(Path origem) {
        ...
        try {
            ...
            // Copia o conteúdo (substitui se já existir)
            Files.copy(origem, destino, StandardCopyOption.REPLACE_EXISTING);

            System.out.println("Arquivo copiado com sucesso para: " + destino);
            return destino;
        } catch (IOException e) {
            e.printStackTrace();
            return null;
